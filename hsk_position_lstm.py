...
from hsk_preprocess import hsk_position_train_serialize, hsk_position_test_serialize, hsk_position_train_sample
...
if __name__ == '__main__':
    ...
    train_file = os.path.join('pickle', 'hsk_position_train.pickle')
    # train_text, train_label = hsk_position_train_sample(train_file, bucket_size=bucket_size, position='right')
    ...
    position_save_file = os.path.join('result', 'track1', 'position_result.txt')
