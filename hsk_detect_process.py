...
from hsk_preprocess import hsk_detect_train_serialize, hsk_detect_test_serialize
...
if __name__ == '__main__':
    ...
    train_text, train_label = hsk_detect_train_serialize(train_file)
    ...
    test_sid, test_text = hsk_detect_test_serialize(test_file)
    ...
    pickle_file = os.path.join('pickle', 'hsk_detect_train.pickle')
