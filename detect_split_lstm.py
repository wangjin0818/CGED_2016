...
if __name__ == '__main__':
    ...
    model.add(Embedding(input_dim=max_features, output_dim=num_features, weights=[W], input_length=maxlen, trainable=False))
    model.add(LSTM(hidden_dim))  # try using a GRU instead, for fun
