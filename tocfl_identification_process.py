...
from tocfl_preprocess import tocfl_identification_train_serialize, tocfl_identification_test_serialize

num_feature = 400
bucket_size = 60

def build_data_train_test(train_text, R_label, M_label, S_label, W_label, test_sid, test_text):
    """
...
if __name__ == '__main__':
    ...
    logging.info('train label sample: %d' % (len(R_label)))
    ...
    revs, vocab = build_data_train_test(train_text, R_label, M_label, S_label, W_label, test_sid, test_text)
