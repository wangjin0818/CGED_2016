...
def build_data_train_test(text, R_label, M_label, S_label, W_label):
    """
    ...
    X_train, X_test, R_train, R_test, M_train, M_test, S_train, S_test, \
        W_train, W_test = train_test_split(ret_text, R_label, M_label, S_label, W_label, \
        random_state=random_state, test_size=test_size)

    # X_train, X_test, R_train, R_test = train_test_split(ret_text, R_label, random_state=random_state, test_size=test_size)
    logging.info('training sample size: %d' % (len(X_train)))
    logging.info('training label size: %d' % (len(R_train)))
    logging.info('testing sample size: %d' % (len(X_test)))
    logging.info('testing label size: %d' % (len(R_test)))
...
if __name__ == '__main__':
    ...
    revs, vocab = build_data_train_test(ret_text, R_label, M_label, S_label, W_label)
