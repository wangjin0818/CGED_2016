...
from hsk_preprocess import hsk_identification_train_serialize, hsk_identification_test_serialize
...
if __name__ == '__main__':
    ...
    pickle_file = os.path.join('pickle', 'hsk_identification_train.pickle')
